...
/**
 * Model tests for FilterSubscriptions
 */
public class FilterSubscriptionsTest {
    private final FilterSubscriptions model = new FilterSubscriptions();
