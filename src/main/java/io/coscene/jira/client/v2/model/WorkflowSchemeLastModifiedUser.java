 ...
 */
@ApiModel(description = "The user that last modified the draft workflow scheme. A modification is a change to the issue type-project mappings only. This property does not apply to non-draft workflows.")
...
public class WorkflowSchemeLastModifiedUser {
  ...
  public WorkflowSchemeLastModifiedUser() {
  }
  ...
  **/
  ...
  public WorkflowSchemeLastModifiedUser avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.self, workflowSchemeLastModifiedUser.self) &&
        Objects.equals(this.key, workflowSchemeLastModifiedUser.key) &&
        Objects.equals(this.accountId, workflowSchemeLastModifiedUser.accountId) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorkflowSchemeLastModifiedUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (WorkflowSchemeLastModifiedUser.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorkflowSchemeLastModifiedUser is not found in the empty JSON string", WorkflowSchemeLastModifiedUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorkflowSchemeLastModifiedUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorkflowSchemeLastModifiedUser` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorkflowSchemeLastModifiedUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorkflowSchemeLastModifiedUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorkflowSchemeLastModifiedUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorkflowSchemeLastModifiedUser.class));

       return (TypeAdapter<T>) new TypeAdapter<WorkflowSchemeLastModifiedUser>() {
           @Override
           public void write(JsonWriter out, WorkflowSchemeLastModifiedUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorkflowSchemeLastModifiedUser read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorkflowSchemeLastModifiedUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorkflowSchemeLastModifiedUser
  * @throws IOException if the JSON string is invalid with respect to WorkflowSchemeLastModifiedUser
  */
  public static WorkflowSchemeLastModifiedUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorkflowSchemeLastModifiedUser.class);
  }

 /**
  * Convert an instance of WorkflowSchemeLastModifiedUser to an JSON string
  *
  * @return JSON string
  */
