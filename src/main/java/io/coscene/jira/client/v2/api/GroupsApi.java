...
import io.coscene.jira.client.v2.model.FoundGroups;
import io.coscene.jira.client.v2.model.Group;
import io.coscene.jira.client.v2.model.PageBeanGroupDetails;
import io.coscene.jira.client.v2.model.PageBeanUserDetails;
...
public class GroupsApi {
     ...
     */
    public okhttp3.Call addUserToGroupCall(Map<String, Object> requestBody, String groupname, String groupId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/group/user";
    ...
    private okhttp3.Call addUserToGroupValidateBeforeCall(Map<String, Object> requestBody, String groupname, String groupId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = addUserToGroupCall(requestBody, groupname, groupId, _callback);
        return localVarCall;
     ...
     */
    public Group addUserToGroup(Map<String, Object> requestBody, String groupname, String groupId) throws ApiException {
     ...
     */
    public ApiResponse<Group> addUserToGroupWithHttpInfo(Map<String, Object> requestBody, String groupname, String groupId) throws ApiException {
     ...
     */
    public okhttp3.Call addUserToGroupAsync(Map<String, Object> requestBody, String groupname, String groupId, final ApiCallback<Group> _callback) throws ApiException {
    ...
    public okhttp3.Call bulkGetGroupsCall(Long startAt, Integer maxResults, Set<String> groupId, Set<String> groupName, String accessType, String applicationKey, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/group/bulk";
    ...
    private okhttp3.Call bulkGetGroupsValidateBeforeCall(Long startAt, Integer maxResults, Set<String> groupId, Set<String> groupName, String accessType, String applicationKey, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = bulkGetGroupsCall(startAt, maxResults, groupId, groupName, accessType, applicationKey, _callback);
        return localVarCall;
    ...
    public okhttp3.Call createGroupCall(Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/group";
     ...
     */
    public okhttp3.Call findGroupsCall(String accountId, String query, List<String> exclude, List<String> excludeId, Integer maxResults, String userName, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/groups/picker";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call findGroupsValidateBeforeCall(String accountId, String query, List<String> exclude, List<String> excludeId, Integer maxResults, String userName, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = findGroupsCall(accountId, query, exclude, excludeId, maxResults, userName, _callback);
        return localVarCall;
     ...
     */
    public FoundGroups findGroups(String accountId, String query, List<String> exclude, List<String> excludeId, Integer maxResults, String userName) throws ApiException {
        ApiResponse<FoundGroups> localVarResp = findGroupsWithHttpInfo(accountId, query, exclude, excludeId, maxResults, userName);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<FoundGroups> findGroupsWithHttpInfo(String accountId, String query, List<String> exclude, List<String> excludeId, Integer maxResults, String userName) throws ApiException {
        okhttp3.Call localVarCall = findGroupsValidateBeforeCall(accountId, query, exclude, excludeId, maxResults, userName, null);
     ...
     */
    public okhttp3.Call findGroupsAsync(String accountId, String query, List<String> exclude, List<String> excludeId, Integer maxResults, String userName, final ApiCallback<FoundGroups> _callback) throws ApiException {

        okhttp3.Call localVarCall = findGroupsValidateBeforeCall(accountId, query, exclude, excludeId, maxResults, userName, _callback);
        Type localVarReturnType = new TypeToken<FoundGroups>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getGroupValidateBeforeCall(String groupname, String groupId, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getGroupCall(groupname, groupId, expand, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getUsersFromGroupCall(String groupname, String groupId, Boolean includeInactiveUsers, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/group/member";
    ...
    private okhttp3.Call getUsersFromGroupValidateBeforeCall(String groupname, String groupId, Boolean includeInactiveUsers, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUsersFromGroupCall(groupname, groupId, includeInactiveUsers, startAt, maxResults, _callback);
        return localVarCall;
    ...
    private okhttp3.Call removeGroupValidateBeforeCall(String groupname, String groupId, String swapGroup, String swapGroupId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeGroupCall(groupname, groupId, swapGroup, swapGroupId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call removeUserFromGroupValidateBeforeCall(String accountId, String groupname, String groupId, String username, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeUserFromGroupCall(accountId, groupname, groupId, username, _callback);
        return localVarCall;
