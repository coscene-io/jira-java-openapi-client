...
import io.coscene.jira.client.v2.model.CreateCustomFieldContext;
import io.coscene.jira.client.v2.model.CustomFieldContextDefaultValueUpdate;
import io.coscene.jira.client.v2.model.CustomFieldContextUpdateDetails;
import io.coscene.jira.client.v2.model.IssueTypeIds;
import io.coscene.jira.client.v2.model.PageBeanContextForProjectAndIssueType;
import io.coscene.jira.client.v2.model.PageBeanCustomFieldContext;
import io.coscene.jira.client.v2.model.PageBeanCustomFieldContextDefaultValue;
import io.coscene.jira.client.v2.model.PageBeanCustomFieldContextProjectMapping;
import io.coscene.jira.client.v2.model.PageBeanIssueTypeToContextMapping;
import io.coscene.jira.client.v2.model.ProjectIds;
import io.coscene.jira.client.v2.model.ProjectIssueTypeMappings;
...
public class IssueCustomFieldContextsApi {
    ...
    public okhttp3.Call addIssueTypesToContextCall(String fieldId, Long contextId, IssueTypeIds issueTypeIds, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}/issuetype"
    ...
    public okhttp3.Call assignProjectsToCustomFieldContextCall(String fieldId, Long contextId, ProjectIds projectIds, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}/project"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()))
            .replaceAll("\\{" + "contextId" + "\\}", localVarApiClient.escapeString(contextId.toString()));
    ...
    public okhttp3.Call createCustomFieldContextCall(String fieldId, CreateCustomFieldContext createCustomFieldContext, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()));
    ...
    public okhttp3.Call deleteCustomFieldContextCall(String fieldId, Long contextId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()))
            .replaceAll("\\{" + "contextId" + "\\}", localVarApiClient.escapeString(contextId.toString()));
    ...
    public okhttp3.Call getCustomFieldContextsForProjectsAndIssueTypesCall(String fieldId, ProjectIssueTypeMappings projectIssueTypeMappings, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/mapping"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()));
    ...
    public okhttp3.Call getDefaultValuesCall(String fieldId, Set<Long> contextId, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/defaultValue"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()));
    ...
    public okhttp3.Call getIssueTypeMappingsForContextsCall(String fieldId, List<Long> contextId, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/issuetypemapping"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()));
    ...
    public okhttp3.Call getProjectContextMappingCall(String fieldId, Set<Long> contextId, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/projectmapping"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()));
    ...
    public okhttp3.Call removeCustomFieldContextFromProjectsCall(String fieldId, Long contextId, ProjectIds projectIds, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}/project/remove"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()))
            .replaceAll("\\{" + "contextId" + "\\}", localVarApiClient.escapeString(contextId.toString()));
    ...
    public okhttp3.Call removeIssueTypesFromContextCall(String fieldId, Long contextId, IssueTypeIds issueTypeIds, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}/issuetype/remove"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()))
            .replaceAll("\\{" + "contextId" + "\\}", localVarApiClient.escapeString(contextId.toString()));
