 ...
 */
@ApiModel(description = "Details of the user who attached the file.")
...
public class AttachmentMetadataAuthor {
  ...
  public AttachmentMetadataAuthor() {
  }
  ...
  **/
  ...
  public AttachmentMetadataAuthor avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.self, attachmentMetadataAuthor.self) &&
        Objects.equals(this.key, attachmentMetadataAuthor.key) &&
        Objects.equals(this.accountId, attachmentMetadataAuthor.accountId) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to AttachmentMetadataAuthor
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AttachmentMetadataAuthor.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in AttachmentMetadataAuthor is not found in the empty JSON string", AttachmentMetadataAuthor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AttachmentMetadataAuthor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AttachmentMetadataAuthor` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AttachmentMetadataAuthor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AttachmentMetadataAuthor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AttachmentMetadataAuthor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AttachmentMetadataAuthor.class));

       return (TypeAdapter<T>) new TypeAdapter<AttachmentMetadataAuthor>() {
           @Override
           public void write(JsonWriter out, AttachmentMetadataAuthor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public AttachmentMetadataAuthor read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of AttachmentMetadataAuthor given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AttachmentMetadataAuthor
  * @throws IOException if the JSON string is invalid with respect to AttachmentMetadataAuthor
  */
  public static AttachmentMetadataAuthor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AttachmentMetadataAuthor.class);
  }

 /**
  * Convert an instance of AttachmentMetadataAuthor to an JSON string
  *
  * @return JSON string
  */
