...
import io.coscene.jira.client.v2.model.PageBeanPriority;
import io.coscene.jira.client.v2.model.Priority;
import io.coscene.jira.client.v2.model.PriorityId;
import io.coscene.jira.client.v2.model.ReorderIssuePriorities;
import io.coscene.jira.client.v2.model.SetDefaultPriorityRequest;
...
public class IssuePrioritiesApi {
     ...
     */
    public okhttp3.Call createPriorityCall(Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/priority";
    ...
    private okhttp3.Call createPriorityValidateBeforeCall(Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createPriorityCall(requestBody, _callback);
        return localVarCall;
     ...
     */
    public PriorityId createPriority(Map<String, Object> requestBody) throws ApiException {
        ApiResponse<PriorityId> localVarResp = createPriorityWithHttpInfo(requestBody);
     ...
     */
    public ApiResponse<PriorityId> createPriorityWithHttpInfo(Map<String, Object> requestBody) throws ApiException {
        okhttp3.Call localVarCall = createPriorityValidateBeforeCall(requestBody, null);
     ...
     */
    public okhttp3.Call createPriorityAsync(Map<String, Object> requestBody, final ApiCallback<PriorityId> _callback) throws ApiException {

        okhttp3.Call localVarCall = createPriorityValidateBeforeCall(requestBody, _callback);
        Type localVarReturnType = new TypeToken<PriorityId>(){}.getType();
    ...
    public okhttp3.Call deletePriorityCall(String id, String replaceWith, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/priority/{id}"
    ...
    private okhttp3.Call deletePriorityValidateBeforeCall(String id, String replaceWith, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deletePriorityCall(id, replaceWith, _callback);
        return localVarCall;
    ...
    public okhttp3.Call movePrioritiesCall(ReorderIssuePriorities reorderIssuePriorities, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/priority/move";
    ...
    private okhttp3.Call movePrioritiesValidateBeforeCall(ReorderIssuePriorities reorderIssuePriorities, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = movePrioritiesCall(reorderIssuePriorities, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call searchPrioritiesCall(Long startAt, Integer maxResults, List<String> id, Boolean onlyDefault, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/priority/search";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchPrioritiesValidateBeforeCall(Long startAt, Integer maxResults, List<String> id, Boolean onlyDefault, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchPrioritiesCall(startAt, maxResults, id, onlyDefault, _callback);
        return localVarCall;
     ...
     */
    public PageBeanPriority searchPriorities(Long startAt, Integer maxResults, List<String> id, Boolean onlyDefault) throws ApiException {
     ...
     */
    public ApiResponse<PageBeanPriority> searchPrioritiesWithHttpInfo(Long startAt, Integer maxResults, List<String> id, Boolean onlyDefault) throws ApiException {
     ...
     */
    public okhttp3.Call searchPrioritiesAsync(Long startAt, Integer maxResults, List<String> id, Boolean onlyDefault, final ApiCallback<PageBeanPriority> _callback) throws ApiException {
    ...
    public okhttp3.Call setDefaultPriorityCall(SetDefaultPriorityRequest setDefaultPriorityRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/priority/default";
    ...
    private okhttp3.Call setDefaultPriorityValidateBeforeCall(SetDefaultPriorityRequest setDefaultPriorityRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setDefaultPriorityCall(setDefaultPriorityRequest, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call updatePriorityCall(String id, Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePriorityValidateBeforeCall(String id, Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updatePriorityCall(id, requestBody, _callback);
        return localVarCall;
     ...
     */
    public Object updatePriority(String id, Map<String, Object> requestBody) throws ApiException {
        ApiResponse<Object> localVarResp = updatePriorityWithHttpInfo(id, requestBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> updatePriorityWithHttpInfo(String id, Map<String, Object> requestBody) throws ApiException {
        okhttp3.Call localVarCall = updatePriorityValidateBeforeCall(id, requestBody, null);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call updatePriorityAsync(String id, Map<String, Object> requestBody, final ApiCallback<Object> _callback) throws ApiException {

        okhttp3.Call localVarCall = updatePriorityValidateBeforeCall(id, requestBody, _callback);
        Type localVarReturnType = new TypeToken<Object>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
