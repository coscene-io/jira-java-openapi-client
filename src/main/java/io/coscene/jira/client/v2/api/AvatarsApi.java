...
import io.coscene.jira.client.v2.model.Avatar;
import io.coscene.jira.client.v2.model.Avatars;
import io.coscene.jira.client.v2.model.SystemAvatars;
...
public class AvatarsApi {
    ...
    public okhttp3.Call deleteAvatarCall(String type, String owningObjectId, Long id, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/universal_avatar/type/{type}/owner/{owningObjectId}/avatar/{id}"
    ...
    public okhttp3.Call getAllSystemAvatarsCall(String type, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/avatar/{type}/system"
            .replaceAll("\\{" + "type" + "\\}", localVarApiClient.escapeString(type.toString()));
    ...
    public okhttp3.Call getAvatarImageByIDCall(String type, Long id, String size, String format, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/universal_avatar/view/type/{type}/avatar/{id}"
            .replaceAll("\\{" + "type" + "\\}", localVarApiClient.escapeString(type.toString()))
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    private okhttp3.Call getAvatarImageByIDValidateBeforeCall(String type, Long id, String size, String format, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAvatarImageByIDCall(type, id, size, format, _callback);
        return localVarCall;
     ...
     */
    public ApiResponse<Object> getAvatarImageByIDWithHttpInfo(String type, Long id, String size, String format) throws ApiException {
     ...
     */
    public okhttp3.Call getAvatarImageByIDAsync(String type, Long id, String size, String format, final ApiCallback<Object> _callback) throws ApiException {
    ...
    public okhttp3.Call getAvatarImageByOwnerCall(String type, String entityId, String size, String format, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/universal_avatar/view/type/{type}/owner/{entityId}"
            .replaceAll("\\{" + "type" + "\\}", localVarApiClient.escapeString(type.toString()))
    ...
    private okhttp3.Call getAvatarImageByOwnerValidateBeforeCall(String type, String entityId, String size, String format, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAvatarImageByOwnerCall(type, entityId, size, format, _callback);
        return localVarCall;
     ...
     */
    public Object getAvatarImageByOwner(String type, String entityId, String size, String format) throws ApiException {
     ...
     */
    public ApiResponse<Object> getAvatarImageByOwnerWithHttpInfo(String type, String entityId, String size, String format) throws ApiException {
     ...
     */
    public okhttp3.Call getAvatarImageByOwnerAsync(String type, String entityId, String size, String format, final ApiCallback<Object> _callback) throws ApiException {
    ...
    public okhttp3.Call getAvatarImageByTypeCall(String type, String size, String format, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/universal_avatar/view/type/{type}"
            .replaceAll("\\{" + "type" + "\\}", localVarApiClient.escapeString(type.toString()));
    ...
    private okhttp3.Call getAvatarImageByTypeValidateBeforeCall(String type, String size, String format, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAvatarImageByTypeCall(type, size, format, _callback);
        return localVarCall;
     ...
     */
    public Object getAvatarImageByType(String type, String size, String format) throws ApiException {
        ApiResponse<Object> localVarResp = getAvatarImageByTypeWithHttpInfo(type, size, format);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Object> getAvatarImageByTypeWithHttpInfo(String type, String size, String format) throws ApiException {
     ...
     */
    public okhttp3.Call getAvatarImageByTypeAsync(String type, String size, String format, final ApiCallback<Object> _callback) throws ApiException {
    ...
    public okhttp3.Call getAvatarsCall(String type, String entityId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/universal_avatar/type/{type}/owner/{entityId}"
            .replaceAll("\\{" + "type" + "\\}", localVarApiClient.escapeString(type.toString()))
            .replaceAll("\\{" + "entityId" + "\\}", localVarApiClient.escapeString(entityId.toString()));
