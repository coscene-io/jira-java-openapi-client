...
import io.coscene.jira.client.v2.model.CreatedIssue;
import io.coscene.jira.client.v2.model.CreatedIssues;
import io.coscene.jira.client.v2.model.IssueBean;
import io.coscene.jira.client.v2.model.IssueChangelogIds;
import io.coscene.jira.client.v2.model.IssueCreateMetadata;
import io.coscene.jira.client.v2.model.IssueEvent;
import io.coscene.jira.client.v2.model.IssueUpdateMetadata;
import io.coscene.jira.client.v2.model.PageBeanChangelog;
import io.coscene.jira.client.v2.model.PageOfChangelogs;
import io.coscene.jira.client.v2.model.Transitions;
import io.coscene.jira.client.v2.model.User;
...
public class IssuesApi {
    ...
    public okhttp3.Call assignIssueCall(String issueIdOrKey, User user, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/assignee"
    ...
    public okhttp3.Call createIssueCall(Map<String, Object> requestBody, Boolean updateHistory, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue";
    ...
    public okhttp3.Call createIssuesCall(Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/bulk";
    ...
    public okhttp3.Call deleteIssueCall(String issueIdOrKey, String deleteSubtasks, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()));
    ...
    public okhttp3.Call doTransitionCall(String issueIdOrKey, Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/transitions"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()));
    ...
    public okhttp3.Call getChangeLogsCall(String issueIdOrKey, Integer startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/changelog"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()));
    ...
    public okhttp3.Call getChangeLogsByIdsCall(String issueIdOrKey, IssueChangelogIds issueChangelogIds, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/changelog/list"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()));
    ...
    private okhttp3.Call getChangeLogsByIdsValidateBeforeCall(String issueIdOrKey, IssueChangelogIds issueChangelogIds, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getChangeLogsByIdsCall(issueIdOrKey, issueChangelogIds, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getCreateIssueMetaCall(List<String> projectIds, List<String> projectKeys, List<String> issuetypeIds, List<String> issuetypeNames, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/createmeta";
    ...
    public okhttp3.Call getEditIssueMetaCall(String issueIdOrKey, Boolean overrideScreenSecurity, Boolean overrideEditableFlag, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/editmeta"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()));
    ...
    public okhttp3.Call getEventsCall(final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/events";
    ...
    private okhttp3.Call getEventsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getEventsCall(_callback);
        return localVarCall;
    ...
    public okhttp3.Call notifyCall(String issueIdOrKey, Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/notify"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()));
