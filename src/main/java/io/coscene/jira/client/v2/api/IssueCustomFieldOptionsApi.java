...
import io.coscene.jira.client.v2.model.BulkCustomFieldOptionCreateRequest;
import io.coscene.jira.client.v2.model.BulkCustomFieldOptionUpdateRequest;
import io.coscene.jira.client.v2.model.CustomFieldCreatedContextOptionsList;
import io.coscene.jira.client.v2.model.CustomFieldOption;
import io.coscene.jira.client.v2.model.CustomFieldUpdatedContextOptionsList;
import io.coscene.jira.client.v2.model.OrderOfCustomFieldOptions;
import io.coscene.jira.client.v2.model.PageBeanCustomFieldContextOption;
...
public class IssueCustomFieldOptionsApi {
    ...
    public okhttp3.Call createCustomFieldOptionCall(String fieldId, Long contextId, BulkCustomFieldOptionCreateRequest bulkCustomFieldOptionCreateRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}/option"
    ...
    public okhttp3.Call deleteCustomFieldOptionCall(String fieldId, Long contextId, Long optionId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}/option/{optionId}"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()))
            .replaceAll("\\{" + "contextId" + "\\}", localVarApiClient.escapeString(contextId.toString()))
    ...
    public okhttp3.Call getCustomFieldOptionCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/customFieldOption/{id}"
    ...
    public okhttp3.Call reorderCustomFieldOptionsCall(String fieldId, Long contextId, OrderOfCustomFieldOptions orderOfCustomFieldOptions, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/context/{contextId}/option/move"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()))
            .replaceAll("\\{" + "contextId" + "\\}", localVarApiClient.escapeString(contextId.toString()));
