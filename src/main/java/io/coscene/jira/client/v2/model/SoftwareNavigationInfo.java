...
public class SoftwareNavigationInfo {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(boardId, boardName, totalBoardsInProject, simpleBoard);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (SoftwareNavigationInfo.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!SoftwareNavigationInfo.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `SoftwareNavigationInfo` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
