 ...
 */
@ApiModel(description = "The ID of the user who updated the comment last.")
...
public class CommentUpdateAuthor {
  ...
  **/
  ...
  public CommentUpdateAuthor avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.self, commentUpdateAuthor.self) &&
        Objects.equals(this.name, commentUpdateAuthor.name) &&
        Objects.equals(this.key, commentUpdateAuthor.key) &&
        Objects.equals(this.accountId, commentUpdateAuthor.accountId) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommentUpdateAuthor
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CommentUpdateAuthor.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommentUpdateAuthor is not found in the empty JSON string", CommentUpdateAuthor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CommentUpdateAuthor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CommentUpdateAuthor` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommentUpdateAuthor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommentUpdateAuthor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommentUpdateAuthor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommentUpdateAuthor.class));

       return (TypeAdapter<T>) new TypeAdapter<CommentUpdateAuthor>() {
           @Override
           public void write(JsonWriter out, CommentUpdateAuthor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public CommentUpdateAuthor read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of CommentUpdateAuthor given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CommentUpdateAuthor
  * @throws IOException if the JSON string is invalid with respect to CommentUpdateAuthor
  */
  public static CommentUpdateAuthor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommentUpdateAuthor.class);
  }

 /**
  * Convert an instance of CommentUpdateAuthor to an JSON string
  *
  * @return JSON string
  */
