...
import io.coscene.jira.client.v2.model.CustomFieldDefinitionJsonBean;
import io.coscene.jira.client.v2.model.FieldDetails;
import io.coscene.jira.client.v2.model.PageBeanContext;
import io.coscene.jira.client.v2.model.PageBeanField;
import io.coscene.jira.client.v2.model.UpdateCustomFieldDetails;
...
public class IssueFieldsApi {
    ...
    public okhttp3.Call createCustomFieldCall(
        CustomFieldDefinitionJsonBean customFieldDefinitionJsonBean, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/field";
    ...
    private okhttp3.Call createCustomFieldValidateBeforeCall(CustomFieldDefinitionJsonBean customFieldDefinitionJsonBean, final ApiCallback _callback) throws
        ApiException {
    ...
    public okhttp3.Call deleteCustomFieldCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{id}"
    ...
    public okhttp3.Call getContextsForFieldDeprecatedCall(String fieldId, Long startAt, Integer maxResults, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/contexts"
    ...
    public okhttp3.Call getFieldsPaginatedCall(Long startAt, Integer maxResults, List<String> type, Set<String> id, String query, String orderBy, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/search";
     ...
     */
    public okhttp3.Call getTrashedFieldsPaginatedCall(Long startAt, Integer maxResults, Set<String> id, String query, String orderBy, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/search/trashed";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getTrashedFieldsPaginatedValidateBeforeCall(Long startAt, Integer maxResults, Set<String> id, String query, String orderBy, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getTrashedFieldsPaginatedCall(startAt, maxResults, id, query, orderBy, _callback);
        return localVarCall;
     ...
     */
    public PageBeanField getTrashedFieldsPaginated(Long startAt, Integer maxResults, Set<String> id, String query, String orderBy) throws ApiException {
        ApiResponse<PageBeanField> localVarResp = getTrashedFieldsPaginatedWithHttpInfo(startAt, maxResults, id, query, orderBy);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PageBeanField> getTrashedFieldsPaginatedWithHttpInfo(Long startAt, Integer maxResults, Set<String> id, String query, String orderBy) throws ApiException {
        okhttp3.Call localVarCall = getTrashedFieldsPaginatedValidateBeforeCall(startAt, maxResults, id, query, orderBy, null);
        Type localVarReturnType = new TypeToken<PageBeanField>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getTrashedFieldsPaginatedAsync(Long startAt, Integer maxResults, Set<String> id, String query, String orderBy, final ApiCallback<PageBeanField> _callback) throws ApiException {

        okhttp3.Call localVarCall = getTrashedFieldsPaginatedValidateBeforeCall(startAt, maxResults, id, query, orderBy, _callback);
        Type localVarReturnType = new TypeToken<PageBeanField>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call restoreCustomFieldCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{id}/restore"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    private okhttp3.Call restoreCustomFieldValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = restoreCustomFieldCall(id, _callback);
        return localVarCall;
    ...
    public okhttp3.Call trashCustomFieldCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{id}/trash"
            .replaceAll("\\{" + "id" + "\\}", localVarApiClient.escapeString(id.toString()));
    ...
    private okhttp3.Call trashCustomFieldValidateBeforeCall(String id, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = trashCustomFieldCall(id, _callback);
        return localVarCall;
    ...
    public okhttp3.Call updateCustomFieldCall(String fieldId, UpdateCustomFieldDetails updateCustomFieldDetails, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()));
