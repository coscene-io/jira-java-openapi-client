...
import io.coscene.jira.client.v2.model.PageBeanScreen;
import io.coscene.jira.client.v2.model.PageBeanScreenWithTab;
import io.coscene.jira.client.v2.model.Screen;
import io.coscene.jira.client.v2.model.ScreenDetails;
import io.coscene.jira.client.v2.model.ScreenableField;
import io.coscene.jira.client.v2.model.UpdateScreenDetails;
...
public class ScreensApi {
    ...
    public okhttp3.Call addFieldToDefaultScreenCall(String fieldId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/screens/addToDefault/{fieldId}"
    ...
    public okhttp3.Call createScreenCall(ScreenDetails screenDetails, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/screens";
    ...
    public okhttp3.Call deleteScreenCall(Long screenId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/screens/{screenId}"
    ...
    public okhttp3.Call getAvailableScreenFieldsCall(Long screenId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/screens/{screenId}/availableFields"
            .replaceAll("\\{" + "screenId" + "\\}", localVarApiClient.escapeString(screenId.toString()));
    ...
    private okhttp3.Call getScreensValidateBeforeCall(Long startAt, Integer maxResults, Set<Long> id, String queryString, Set<String> scope, String orderBy, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getScreensCall(startAt, maxResults, id, queryString, scope, orderBy, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getScreensForFieldCall(String fieldId, Long startAt, Integer maxResults, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/field/{fieldId}/screens"
            .replaceAll("\\{" + "fieldId" + "\\}", localVarApiClient.escapeString(fieldId.toString()));
