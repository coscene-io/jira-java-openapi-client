 ...
 */
@ApiModel(description = "The user subscribing to filter.")
...
public class FilterSubscriptionUser {
  ...
  **/
  ...
  public FilterSubscriptionUser avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FilterSubscriptionUser filterSubscriptionUser = (FilterSubscriptionUser) o;
    return Objects.equals(this.self, filterSubscriptionUser.self) &&
        Objects.equals(this.key, filterSubscriptionUser.key) &&
        Objects.equals(this.accountId, filterSubscriptionUser.accountId) &&
        Objects.equals(this.accountType, filterSubscriptionUser.accountType) &&
        Objects.equals(this.name, filterSubscriptionUser.name) &&
        Objects.equals(this.emailAddress, filterSubscriptionUser.emailAddress) &&
        Objects.equals(this.avatarUrls, filterSubscriptionUser.avatarUrls) &&
        Objects.equals(this.displayName, filterSubscriptionUser.displayName) &&
        Objects.equals(this.active, filterSubscriptionUser.active) &&
        Objects.equals(this.timeZone, filterSubscriptionUser.timeZone) &&
        Objects.equals(this.locale, filterSubscriptionUser.locale) &&
        Objects.equals(this.groups, filterSubscriptionUser.groups) &&
        Objects.equals(this.applicationRoles, filterSubscriptionUser.applicationRoles) &&
        Objects.equals(this.expand, filterSubscriptionUser.expand);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FilterSubscriptionUser
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FilterSubscriptionUser.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterSubscriptionUser is not found in the empty JSON string", FilterSubscriptionUser.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FilterSubscriptionUser.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterSubscriptionUser` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilterSubscriptionUser.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilterSubscriptionUser' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilterSubscriptionUser> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilterSubscriptionUser.class));

       return (TypeAdapter<T>) new TypeAdapter<FilterSubscriptionUser>() {
           @Override
           public void write(JsonWriter out, FilterSubscriptionUser value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FilterSubscriptionUser read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FilterSubscriptionUser given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FilterSubscriptionUser
  * @throws IOException if the JSON string is invalid with respect to FilterSubscriptionUser
  */
  public static FilterSubscriptionUser fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilterSubscriptionUser.class);
  }

 /**
  * Convert an instance of FilterSubscriptionUser to an JSON string
  *
  * @return JSON string
  */
