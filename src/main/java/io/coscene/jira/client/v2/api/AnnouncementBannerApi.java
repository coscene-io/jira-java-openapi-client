...
public class AnnouncementBannerApi {
    ...
    public okhttp3.Call getBannerCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/announcementBanner";
    ...
    private okhttp3.Call getBannerValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getBannerCall(_callback);
        return localVarCall;
    ...
    public okhttp3.Call setBannerCall(
        AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call setBannerValidateBeforeCall(AnnouncementBannerConfigurationUpdate announcementBannerConfigurationUpdate, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setBannerCall(announcementBannerConfigurationUpdate, _callback);
        return localVarCall;
