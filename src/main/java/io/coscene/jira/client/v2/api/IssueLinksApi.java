...
import io.coscene.jira.client.v2.model.IssueLink;
import io.coscene.jira.client.v2.model.LinkIssueRequestJsonBean;
...
public class IssueLinksApi {
    ...
    public okhttp3.Call deleteIssueLinkCall(String linkId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/issueLink/{linkId}"
    ...
    public okhttp3.Call linkIssuesCall(LinkIssueRequestJsonBean linkIssueRequestJsonBean, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issueLink";
