...
public class AvatarUrlsBean {
  ...
  * @throws IOException if the JSON Object is invalid with respect to AvatarUrlsBean
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (AvatarUrlsBean.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!AvatarUrlsBean.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `AvatarUrlsBean` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
