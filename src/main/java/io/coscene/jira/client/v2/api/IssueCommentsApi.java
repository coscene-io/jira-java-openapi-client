...
import io.coscene.jira.client.v2.model.Comment;
import io.coscene.jira.client.v2.model.IssueCommentListRequestBean;
import io.coscene.jira.client.v2.model.PageBeanComment;
import io.coscene.jira.client.v2.model.PageOfComments;
...
public class IssueCommentsApi {
    ...
    public okhttp3.Call addCommentCall(String issueIdOrKey, Map<String, Object> requestBody, String expand, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/comment"
    ...
    public okhttp3.Call deleteCommentCall(String issueIdOrKey, String id, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/comment/{id}"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()))
    ...
    public okhttp3.Call getCommentsByIdsCall(IssueCommentListRequestBean issueCommentListRequestBean, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/comment/list";
     ...
     */
    public okhttp3.Call updateCommentCall(String issueIdOrKey, String id, Map<String, Object> requestBody, Boolean notifyUsers, Boolean overrideEditableFlag, String expand, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    private okhttp3.Call updateCommentValidateBeforeCall(String issueIdOrKey, String id, Map<String, Object> requestBody, Boolean notifyUsers, Boolean overrideEditableFlag, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateCommentCall(issueIdOrKey, id, requestBody, notifyUsers, overrideEditableFlag, expand, _callback);
        return localVarCall;
     ...
     */
    public Comment updateComment(String issueIdOrKey, String id, Map<String, Object> requestBody, Boolean notifyUsers, Boolean overrideEditableFlag, String expand) throws ApiException {
     ...
     */
    public ApiResponse<Comment> updateCommentWithHttpInfo(String issueIdOrKey, String id, Map<String, Object> requestBody, Boolean notifyUsers, Boolean overrideEditableFlag, String expand) throws ApiException {
     ...
     */
    public okhttp3.Call updateCommentAsync(String issueIdOrKey, String id, Map<String, Object> requestBody, Boolean notifyUsers, Boolean overrideEditableFlag, String expand, final ApiCallback<Comment> _callback) throws ApiException {
