...
import io.coscene.jira.client.v2.model.IdBean;
import io.coscene.jira.client.v2.model.PermissionScheme;
import io.coscene.jira.client.v2.model.ProjectIssueSecurityLevels;
import io.coscene.jira.client.v2.model.SecurityScheme;
...
public class ProjectPermissionSchemesApi {
    ...
    public okhttp3.Call assignPermissionSchemeCall(String projectKeyOrId, IdBean idBean, String expand, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/project/{projectKeyOrId}/permissionscheme"
    ...
    public okhttp3.Call getProjectIssueSecuritySchemeCall(String projectKeyOrId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/project/{projectKeyOrId}/issuesecuritylevelscheme"
            .replaceAll("\\{" + "projectKeyOrId" + "\\}", localVarApiClient.escapeString(projectKeyOrId.toString()));
    ...
    public okhttp3.Call getSecurityLevelsForProjectCall(String projectKeyOrId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/project/{projectKeyOrId}/securitylevel"
            .replaceAll("\\{" + "projectKeyOrId" + "\\}", localVarApiClient.escapeString(projectKeyOrId.toString()));
