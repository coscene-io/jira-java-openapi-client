...
import io.coscene.jira.client.v2.model.Locale;
...
public class MyselfApi {
    ...
    public okhttp3.Call deleteLocaleCall(final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/mypreferences/locale";
    ...
    public okhttp3.Call getCurrentUserCall(String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/myself";
    ...
    public okhttp3.Call getPreferenceCall(String key, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/mypreferences";
