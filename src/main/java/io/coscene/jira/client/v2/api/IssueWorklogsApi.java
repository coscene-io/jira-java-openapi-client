...
import io.coscene.jira.client.v2.model.ChangedWorklogs;
import io.coscene.jira.client.v2.model.PageOfWorklogs;
import io.coscene.jira.client.v2.model.Worklog;
import io.coscene.jira.client.v2.model.WorklogIdsRequestBean;
...
public class IssueWorklogsApi {
    ...
    public okhttp3.Call addWorklogCall(String issueIdOrKey, Map<String, Object> requestBody, Boolean notifyUsers, String adjustEstimate, String newEstimate, String reduceBy, String expand, Boolean overrideEditableFlag, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/worklog"
    ...
    public okhttp3.Call deleteWorklogCall(String issueIdOrKey, String id, Boolean notifyUsers, String adjustEstimate, String newEstimate, String increaseBy, Boolean overrideEditableFlag, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/issue/{issueIdOrKey}/worklog/{id}"
            .replaceAll("\\{" + "issueIdOrKey" + "\\}", localVarApiClient.escapeString(issueIdOrKey.toString()))
    ...
    public okhttp3.Call getIdsOfWorklogsDeletedSinceCall(Long since, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/worklog/deleted";
    ...
    public okhttp3.Call getIdsOfWorklogsModifiedSinceCall(Long since, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/worklog/updated";
    ...
    private okhttp3.Call getIssueWorklogValidateBeforeCall(String issueIdOrKey, Long startAt, Integer maxResults, Long startedAfter, Long startedBefore, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getIssueWorklogCall(issueIdOrKey, startAt, maxResults, startedAfter, startedBefore, expand, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getWorklogsForIdsCall(WorklogIdsRequestBean worklogIdsRequestBean, String expand, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/worklog/list";
