...
public class IssueTypeCreateBean {
  ...
  * @throws IOException if the JSON Object is invalid with respect to IssueTypeCreateBean
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (IssueTypeCreateBean.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!IssueTypeCreateBean.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `IssueTypeCreateBean` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
