...
public class MultipleCustomFieldValuesUpdate {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (MultipleCustomFieldValuesUpdate.openapiRequiredFields.isEmpty()) {
          return;
      ...
      if ((jsonObj.get("customField") != null && !jsonObj.get("customField").isJsonNull()) && !jsonObj.get("customField").isJsonPrimitive()) {
