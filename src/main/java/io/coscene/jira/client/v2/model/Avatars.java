...
public class Avatars {
  ...
  * @throws IOException if the JSON Object is invalid with respect to Avatars
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Avatars.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!Avatars.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `Avatars` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
