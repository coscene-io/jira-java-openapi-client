...
import io.coscene.jira.client.v2.model.PageBeanResolutionJsonBean;
import io.coscene.jira.client.v2.model.ReorderIssueResolutionsRequest;
import io.coscene.jira.client.v2.model.Resolution;
import io.coscene.jira.client.v2.model.ResolutionId;
import io.coscene.jira.client.v2.model.SetDefaultResolutionRequest;
...
public class IssueResolutionsApi {
    ...
    public okhttp3.Call createResolutionCall(Map<String, Object> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/2/resolution";
    ...
    public okhttp3.Call deleteResolutionCall(String id, String replaceWith, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/resolution/{id}"
    ...
    public okhttp3.Call moveResolutionsCall(ReorderIssueResolutionsRequest reorderIssueResolutionsRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/resolution/move";
    ...
    public okhttp3.Call searchResolutionsCall(Long startAt, Integer maxResults, List<String> id, Boolean onlyDefault, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/resolution/search";
    ...
    public okhttp3.Call setDefaultResolutionCall(SetDefaultResolutionRequest setDefaultResolutionRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/rest/api/2/resolution/default";
