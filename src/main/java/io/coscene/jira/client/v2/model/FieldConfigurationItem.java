...
public class FieldConfigurationItem {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, description, isHidden, isRequired, renderer);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FieldConfigurationItem
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FieldConfigurationItem.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FieldConfigurationItem.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FieldConfigurationItem` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
