 ...
 */
@ApiModel(description = "The user who owns the filter. This is defaulted to the creator of the filter, however Jira administrators can change the owner of a shared filter in the admin settings.")
...
public class FilterOwner {
  ...
  **/
  ...
  public FilterOwner avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FilterOwner filterOwner = (FilterOwner) o;
    return Objects.equals(this.self, filterOwner.self) &&
        Objects.equals(this.key, filterOwner.key) &&
        Objects.equals(this.accountId, filterOwner.accountId) &&
        Objects.equals(this.accountType, filterOwner.accountType) &&
        Objects.equals(this.name, filterOwner.name) &&
        Objects.equals(this.emailAddress, filterOwner.emailAddress) &&
        Objects.equals(this.avatarUrls, filterOwner.avatarUrls) &&
        Objects.equals(this.displayName, filterOwner.displayName) &&
        Objects.equals(this.active, filterOwner.active) &&
        Objects.equals(this.timeZone, filterOwner.timeZone) &&
        Objects.equals(this.locale, filterOwner.locale) &&
        Objects.equals(this.groups, filterOwner.groups) &&
        Objects.equals(this.applicationRoles, filterOwner.applicationRoles) &&
        Objects.equals(this.expand, filterOwner.expand);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FilterOwner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FilterOwner.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterOwner is not found in the empty JSON string", FilterOwner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FilterOwner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterOwner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilterOwner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilterOwner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilterOwner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilterOwner.class));

       return (TypeAdapter<T>) new TypeAdapter<FilterOwner>() {
           @Override
           public void write(JsonWriter out, FilterOwner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FilterOwner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FilterOwner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FilterOwner
  * @throws IOException if the JSON string is invalid with respect to FilterOwner
  */
  public static FilterOwner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilterOwner.class);
  }

 /**
  * Convert an instance of FilterOwner to an JSON string
  *
  * @return JSON string
  */
