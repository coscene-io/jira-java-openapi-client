...
public class CustomFieldValueUpdate {
  ...
  * @throws IOException if the JSON Object is invalid with respect to CustomFieldValueUpdate
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CustomFieldValueUpdate.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!CustomFieldValueUpdate.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `CustomFieldValueUpdate` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
