...
import io.coscene.jira.client.v3.model.ConnectCustomFieldValues;
import io.coscene.jira.client.v3.model.EntityPropertyDetails;
import java.util.UUID;
import io.coscene.jira.client.v3.model.WorkflowRulesSearch;
import io.coscene.jira.client.v3.model.WorkflowRulesSearchDetails;
...
public class AppMigrationApi {
    ...
    private okhttp3.Call appIssueFieldValueUpdateResourceUpdateIssueFieldsPutValidateBeforeCall(UUID atlassianTransferId, ConnectCustomFieldValues connectCustomFieldValues, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = appIssueFieldValueUpdateResourceUpdateIssueFieldsPutCall(atlassianTransferId, connectCustomFieldValues, _callback);
        return localVarCall;
    ...
    private okhttp3.Call migrationResourceUpdateEntityPropertiesValuePutValidateBeforeCall(UUID atlassianTransferId, String entityType, List<EntityPropertyDetails> entityPropertyDetails, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = migrationResourceUpdateEntityPropertiesValuePutCall(atlassianTransferId, entityType, entityPropertyDetails, _callback);
        return localVarCall;
    ...
    private okhttp3.Call migrationResourceWorkflowRuleSearchPostValidateBeforeCall(UUID atlassianTransferId, WorkflowRulesSearch workflowRulesSearch, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = migrationResourceWorkflowRuleSearchPostCall(atlassianTransferId, workflowRulesSearch, _callback);
        return localVarCall;
