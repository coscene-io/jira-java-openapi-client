...
public class FieldConfigurationItemsDetails {
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FieldConfigurationItemsDetails.openapiRequiredFields.isEmpty()) {
          return;
      ...
      if (jsonObj.get("fieldConfigurationItems") != null && !jsonObj.get("fieldConfigurationItems").isJsonNull()) {
        JsonArray jsonArrayfieldConfigurationItems = jsonObj.getAsJsonArray("fieldConfigurationItems");
        if (jsonArrayfieldConfigurationItems != null) {
