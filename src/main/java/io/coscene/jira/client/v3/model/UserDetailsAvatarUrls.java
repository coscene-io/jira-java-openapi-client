 ...
 */
@ApiModel(description = "The avatars of the user.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2022-10-31T17:36:49.012380+08:00[Asia/Shanghai]")
public class UserDetailsAvatarUrls {
  ...
  public UserDetailsAvatarUrls() {
  }

  public UserDetailsAvatarUrls _16x16(URI _16x16) {
  ...
  **/
  ...
  public UserDetailsAvatarUrls _24x24(URI _24x24) {
  ...
  **/
  ...
  public UserDetailsAvatarUrls _32x32(URI _32x32) {
  ...
  **/
  ...
  public UserDetailsAvatarUrls _48x48(URI _48x48) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    UserDetailsAvatarUrls userDetailsAvatarUrls = (UserDetailsAvatarUrls) o;
    return Objects.equals(this._16x16, userDetailsAvatarUrls._16x16) &&
        Objects.equals(this._24x24, userDetailsAvatarUrls._24x24) &&
        Objects.equals(this._32x32, userDetailsAvatarUrls._32x32) &&
        Objects.equals(this._48x48, userDetailsAvatarUrls._48x48);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserDetailsAvatarUrls {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to UserDetailsAvatarUrls
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (UserDetailsAvatarUrls.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in UserDetailsAvatarUrls is not found in the empty JSON string", UserDetailsAvatarUrls.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!UserDetailsAvatarUrls.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `UserDetailsAvatarUrls` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!UserDetailsAvatarUrls.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'UserDetailsAvatarUrls' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<UserDetailsAvatarUrls> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(UserDetailsAvatarUrls.class));

       return (TypeAdapter<T>) new TypeAdapter<UserDetailsAvatarUrls>() {
           @Override
           public void write(JsonWriter out, UserDetailsAvatarUrls value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public UserDetailsAvatarUrls read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of UserDetailsAvatarUrls given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of UserDetailsAvatarUrls
  * @throws IOException if the JSON string is invalid with respect to UserDetailsAvatarUrls
  */
  public static UserDetailsAvatarUrls fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, UserDetailsAvatarUrls.class);
  }

 /**
  * Convert an instance of UserDetailsAvatarUrls to an JSON string
  *
  * @return JSON string
  */
