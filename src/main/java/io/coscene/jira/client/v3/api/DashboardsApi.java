...
import io.coscene.jira.client.v3.model.AvailableDashboardGadgetsResponse;
import io.coscene.jira.client.v3.model.Dashboard;
import io.coscene.jira.client.v3.model.DashboardDetails;
import io.coscene.jira.client.v3.model.DashboardGadget;
import io.coscene.jira.client.v3.model.DashboardGadgetResponse;
import io.coscene.jira.client.v3.model.DashboardGadgetSettings;
import io.coscene.jira.client.v3.model.DashboardGadgetUpdateRequest;
import io.coscene.jira.client.v3.model.EntityProperty;
import io.coscene.jira.client.v3.model.PageBeanDashboard;
import io.coscene.jira.client.v3.model.PageOfDashboards;
...
public class DashboardsApi {
    ...
    private okhttp3.Call addGadgetValidateBeforeCall(Long dashboardId, DashboardGadgetSettings dashboardGadgetSettings, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = addGadgetCall(dashboardId, dashboardGadgetSettings, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getAllAvailableDashboardGadgetsValidateBeforeCall(final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllAvailableDashboardGadgetsCall(_callback);
        return localVarCall;
    ...
    private okhttp3.Call getAllGadgetsValidateBeforeCall(Long dashboardId, List<String> moduleKey, List<String> uri, List<Long> gadgetId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllGadgetsCall(dashboardId, moduleKey, uri, gadgetId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getDashboardsPaginatedValidateBeforeCall(String dashboardName, String accountId, String owner, String groupname, String groupId, Long projectId, String orderBy, Long startAt, Integer maxResults, String status, String expand, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDashboardsPaginatedCall(dashboardName, accountId, owner, groupname, groupId, projectId, orderBy, startAt, maxResults, status, expand, _callback);
        return localVarCall;
    ...
    public okhttp3.Call removeGadgetCall(Long dashboardId, Long gadgetId, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/rest/api/3/dashboard/{dashboardId}/gadget/{gadgetId}"
            .replaceAll("\\{" + "dashboardId" + "\\}", localVarApiClient.escapeString(dashboardId.toString()))
            .replaceAll("\\{" + "gadgetId" + "\\}", localVarApiClient.escapeString(gadgetId.toString()));
    ...
    private okhttp3.Call removeGadgetValidateBeforeCall(Long dashboardId, Long gadgetId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = removeGadgetCall(dashboardId, gadgetId, _callback);
        return localVarCall;
    ...
    private okhttp3.Call updateGadgetValidateBeforeCall(Long dashboardId, Long gadgetId, DashboardGadgetUpdateRequest dashboardGadgetUpdateRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = updateGadgetCall(dashboardId, gadgetId, dashboardGadgetUpdateRequest, _callback);
        return localVarCall;
