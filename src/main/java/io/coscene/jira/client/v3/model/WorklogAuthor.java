 ...
 */
@ApiModel(description = "Details of the user who created the worklog.")
...
public class WorklogAuthor {
  ...
  **/
  ...
  public WorklogAuthor avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.self, worklogAuthor.self) &&
        Objects.equals(this.name, worklogAuthor.name) &&
        Objects.equals(this.key, worklogAuthor.key) &&
        Objects.equals(this.accountId, worklogAuthor.accountId) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to WorklogAuthor
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (WorklogAuthor.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in WorklogAuthor is not found in the empty JSON string", WorklogAuthor.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!WorklogAuthor.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `WorklogAuthor` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!WorklogAuthor.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'WorklogAuthor' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<WorklogAuthor> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(WorklogAuthor.class));

       return (TypeAdapter<T>) new TypeAdapter<WorklogAuthor>() {
           @Override
           public void write(JsonWriter out, WorklogAuthor value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public WorklogAuthor read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of WorklogAuthor given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of WorklogAuthor
  * @throws IOException if the JSON string is invalid with respect to WorklogAuthor
  */
  public static WorklogAuthor fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, WorklogAuthor.class);
  }

 /**
  * Convert an instance of WorklogAuthor to an JSON string
  *
  * @return JSON string
  */
