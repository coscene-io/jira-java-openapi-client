 ...
 */
@ApiModel(description = "The user who owns the filter. Defaults to the creator of the filter, however, Jira administrators can change the owner of a shared filter in the admin settings.")
...
public class FilterDetailsOwner {
  ...
  **/
  ...
  public FilterDetailsOwner avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    FilterDetailsOwner filterDetailsOwner = (FilterDetailsOwner) o;
    return Objects.equals(this.self, filterDetailsOwner.self) &&
        Objects.equals(this.key, filterDetailsOwner.key) &&
        Objects.equals(this.accountId, filterDetailsOwner.accountId) &&
        Objects.equals(this.accountType, filterDetailsOwner.accountType) &&
        Objects.equals(this.name, filterDetailsOwner.name) &&
        Objects.equals(this.emailAddress, filterDetailsOwner.emailAddress) &&
        Objects.equals(this.avatarUrls, filterDetailsOwner.avatarUrls) &&
        Objects.equals(this.displayName, filterDetailsOwner.displayName) &&
        Objects.equals(this.active, filterDetailsOwner.active) &&
        Objects.equals(this.timeZone, filterDetailsOwner.timeZone) &&
        Objects.equals(this.locale, filterDetailsOwner.locale) &&
        Objects.equals(this.groups, filterDetailsOwner.groups) &&
        Objects.equals(this.applicationRoles, filterDetailsOwner.applicationRoles) &&
        Objects.equals(this.expand, filterDetailsOwner.expand);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to FilterDetailsOwner
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (FilterDetailsOwner.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in FilterDetailsOwner is not found in the empty JSON string", FilterDetailsOwner.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!FilterDetailsOwner.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `FilterDetailsOwner` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FilterDetailsOwner.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FilterDetailsOwner' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FilterDetailsOwner> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FilterDetailsOwner.class));

       return (TypeAdapter<T>) new TypeAdapter<FilterDetailsOwner>() {
           @Override
           public void write(JsonWriter out, FilterDetailsOwner value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public FilterDetailsOwner read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of FilterDetailsOwner given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FilterDetailsOwner
  * @throws IOException if the JSON string is invalid with respect to FilterDetailsOwner
  */
  public static FilterDetailsOwner fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FilterDetailsOwner.class);
  }

 /**
  * Convert an instance of FilterDetailsOwner to an JSON string
  *
  * @return JSON string
  */
