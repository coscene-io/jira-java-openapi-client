 ...
 */
@ApiModel(description = "The username of the project lead.")
...
public class ProjectLead {
  ...
  **/
  ...
  public ProjectLead key(String key) {
  ...
  **/
  ...
  public ProjectLead accountId(String accountId) {
  ...
  **/
  ...
  public ProjectLead name(String name) {
  ...
  **/
  ...
  public ProjectLead avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public ProjectLead groups(UserGroups groups) {
  ...
  **/
  ...
  public ProjectLead applicationRoles(UserApplicationRoles applicationRoles) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ProjectLead projectLead = (ProjectLead) o;
    return Objects.equals(this.self, projectLead.self) &&
        Objects.equals(this.key, projectLead.key) &&
        Objects.equals(this.accountId, projectLead.accountId) &&
        Objects.equals(this.accountType, projectLead.accountType) &&
        Objects.equals(this.name, projectLead.name) &&
        Objects.equals(this.emailAddress, projectLead.emailAddress) &&
        Objects.equals(this.avatarUrls, projectLead.avatarUrls) &&
        Objects.equals(this.displayName, projectLead.displayName) &&
        Objects.equals(this.active, projectLead.active) &&
        Objects.equals(this.timeZone, projectLead.timeZone) &&
        Objects.equals(this.locale, projectLead.locale) &&
        Objects.equals(this.groups, projectLead.groups) &&
        Objects.equals(this.applicationRoles, projectLead.applicationRoles) &&
        Objects.equals(this.expand, projectLead.expand);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ProjectLead
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ProjectLead.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ProjectLead is not found in the empty JSON string", ProjectLead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ProjectLead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ProjectLead` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ProjectLead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ProjectLead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ProjectLead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ProjectLead.class));

       return (TypeAdapter<T>) new TypeAdapter<ProjectLead>() {
           @Override
           public void write(JsonWriter out, ProjectLead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ProjectLead read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ProjectLead given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ProjectLead
  * @throws IOException if the JSON string is invalid with respect to ProjectLead
  */
  public static ProjectLead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ProjectLead.class);
  }

 /**
  * Convert an instance of ProjectLead to an JSON string
  *
  * @return JSON string
  */
