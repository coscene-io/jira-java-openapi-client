...
public class PageBeanFieldConfigurationScheme {
  ...
  * @throws IOException if the JSON Object is invalid with respect to PageBeanFieldConfigurationScheme
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (PageBeanFieldConfigurationScheme.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!PageBeanFieldConfigurationScheme.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `PageBeanFieldConfigurationScheme` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
      ...
      if (jsonObj.get("values") != null && !jsonObj.get("values").isJsonNull()) {
        ...
        if (jsonArrayvalues != null) {
          ...
          for (int i = 0; i < jsonArrayvalues.size(); i++) {
            FieldConfigurationScheme.validateJsonObject(jsonArrayvalues.get(i).getAsJsonObject());
          };
        }
      }
  }
