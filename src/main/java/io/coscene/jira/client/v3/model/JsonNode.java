...
public class JsonNode {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(array, fields, _null, elements, containerNode, valueNode, pojo, number, integralNumber, _int, _long, _double, bigDecimal, bigInteger, textual, _boolean, binary, _object, missingNode, floatingPointNumber, numberValue, numberType, intValue, longValue, bigIntegerValue, doubleValue, decimalValue, booleanValue, binaryValue, valueAsInt, valueAsLong, valueAsDouble, valueAsBoolean, textValue, valueAsText, fieldNames);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (JsonNode.openapiRequiredFields.isEmpty()) {
          return;
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!JsonNode.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `JsonNode` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
