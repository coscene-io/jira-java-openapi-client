...
public class CreatePriorityDetails {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, createPriorityDetails.name) &&
  ...
  * @throws IOException if the JSON Object is invalid with respect to CreatePriorityDetails
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (CreatePriorityDetails.openapiRequiredFields.isEmpty()) {
          return;
