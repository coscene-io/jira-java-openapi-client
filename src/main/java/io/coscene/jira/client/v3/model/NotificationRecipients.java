...
public class NotificationRecipients {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(reporter, assignee, watchers, voters, users, groups, groupIds, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (NotificationRecipients.openapiRequiredFields.isEmpty()) {
          return;
