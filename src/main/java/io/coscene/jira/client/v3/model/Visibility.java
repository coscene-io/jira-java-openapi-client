...
public class Visibility {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, visibility.type) &&
        ...
        Objects.equals(this.identifier, visibility.identifier)&&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, value, identifier, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Visibility
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (Visibility.openapiRequiredFields.isEmpty()) {
          return;
