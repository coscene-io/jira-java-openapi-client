...
public class ComponentWithIssueCountLead {
  ...
  public ComponentWithIssueCountLead() {
  }
  ...
  **/
  ...
  public ComponentWithIssueCountLead key(String key) {
  ...
  **/
  ...
  public ComponentWithIssueCountLead accountId(String accountId) {
  ...
  **/
  ...
  public ComponentWithIssueCountLead name(String name) {
  ...
  **/
  ...
  public ComponentWithIssueCountLead avatarUrls(UserDetailsAvatarUrls avatarUrls) {
  ...
  **/
  ...
  public ComponentWithIssueCountLead groups(UserGroups groups) {
  ...
  **/
  ...
  public ComponentWithIssueCountLead applicationRoles(UserApplicationRoles applicationRoles) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    ComponentWithIssueCountLead componentWithIssueCountLead = (ComponentWithIssueCountLead) o;
    return Objects.equals(this.self, componentWithIssueCountLead.self) &&
        Objects.equals(this.key, componentWithIssueCountLead.key) &&
        Objects.equals(this.accountId, componentWithIssueCountLead.accountId) &&
        Objects.equals(this.accountType, componentWithIssueCountLead.accountType) &&
        Objects.equals(this.name, componentWithIssueCountLead.name) &&
        Objects.equals(this.emailAddress, componentWithIssueCountLead.emailAddress) &&
        Objects.equals(this.avatarUrls, componentWithIssueCountLead.avatarUrls) &&
        Objects.equals(this.displayName, componentWithIssueCountLead.displayName) &&
        Objects.equals(this.active, componentWithIssueCountLead.active) &&
        Objects.equals(this.timeZone, componentWithIssueCountLead.timeZone) &&
        Objects.equals(this.locale, componentWithIssueCountLead.locale) &&
        Objects.equals(this.groups, componentWithIssueCountLead.groups) &&
        Objects.equals(this.applicationRoles, componentWithIssueCountLead.applicationRoles) &&
        Objects.equals(this.expand, componentWithIssueCountLead.expand);
  }
  ...
  public String toString() {
    ...
    sb.append("class ComponentWithIssueCountLead {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ComponentWithIssueCountLead
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (ComponentWithIssueCountLead.openapiRequiredFields.isEmpty()) {
          return;
        } else { // has required fields
          throw new IllegalArgumentException(String.format("The required field(s) %s in ComponentWithIssueCountLead is not found in the empty JSON string", ComponentWithIssueCountLead.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!ComponentWithIssueCountLead.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `ComponentWithIssueCountLead` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ComponentWithIssueCountLead.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ComponentWithIssueCountLead' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ComponentWithIssueCountLead> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ComponentWithIssueCountLead.class));

       return (TypeAdapter<T>) new TypeAdapter<ComponentWithIssueCountLead>() {
           @Override
           public void write(JsonWriter out, ComponentWithIssueCountLead value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public ComponentWithIssueCountLead read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of ComponentWithIssueCountLead given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ComponentWithIssueCountLead
  * @throws IOException if the JSON string is invalid with respect to ComponentWithIssueCountLead
  */
  public static ComponentWithIssueCountLead fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ComponentWithIssueCountLead.class);
  }

 /**
  * Convert an instance of ComponentWithIssueCountLead to an JSON string
  *
  * @return JSON string
  */
