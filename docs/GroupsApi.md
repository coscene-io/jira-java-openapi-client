...
# **addUserToGroup**
> Group addUserToGroup(requestBody, groupname, groupId)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Group result = apiInstance.addUserToGroup(requestBody, groupname, groupId);
...
<a name="findGroups"></a>
# **findGroups**
> FoundGroups findGroups(accountId, query, exclude, excludeId, maxResults, userName)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      FoundGroups result = apiInstance.findGroups(accountId, query, exclude, excludeId, maxResults, userName);
      System.out.println(result);
    } catch (ApiException e) {
