...
# **getAvatarImageByID**
> Object getAvatarImageByID(type, id, size, format)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Object result = apiInstance.getAvatarImageByID(type, id, size, format);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object getAvatarImageByOwner(type, entityId, size, format)
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "png"; // String | The format to return the avatar image in. If not provided the original content format is returned.
    try {
      Object result = apiInstance.getAvatarImageByOwner(type, entityId, size, format);
      System.out.println(result);
    } catch (ApiException e) {
...
> Object getAvatarImageByType(type, size, format)
...
public class Example {
  public static void main(String[] args) {
    ...
    String format = "png"; // String | The format to return the avatar image in. If not provided the original content format is returned.
    try {
      Object result = apiInstance.getAvatarImageByType(type, size, format);
      System.out.println(result);
    } catch (ApiException e) {
