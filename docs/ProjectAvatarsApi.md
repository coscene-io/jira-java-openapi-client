...
# **updateProjectAvatar**
> Object updateProjectAvatar(projectIdOrKey, requestBody)
...
public class Example {
  public static void main(String[] args) {
    ...
    ProjectAvatarsApi apiInstance = new ProjectAvatarsApi(defaultClient);
    String projectIdOrKey = "projectIdOrKey_example"; // String | The ID or (case-sensitive) key of the project.
    Map<String, Object> requestBody = {"id":"10010"}; // Map<String, Object> | 
    try {
      Object result = apiInstance.updateProjectAvatar(projectIdOrKey, requestBody);
      System.out.println(result);
    } catch (ApiException e) {
